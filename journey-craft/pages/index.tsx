  ...
  return (
    <Layout>
      <div className='flex flex-col justify-center items-center'>
        ...
        <Link className="text-lg" href = "/generate">
        ...
        <Link className="border border-2 text-lg w-auto hover:border-white px-5 h-full w-auto flex justify-evenly items-center hover:bg-gradient-to-r hover:from-violet-200 hover:to-emerald-200" href="/register">Sign Up!</Link>
      </div>
